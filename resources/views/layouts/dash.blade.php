                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link @if (Request::is('deposit')) active @endif"
                                href="{{ url('/deposit') }}">
                                <span class="nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <span class="nav-link-text">Deposit Now</span>
                            </a>
                            <!--//nav-link-->
                        </li>
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link @if (Request::is('deposit_list')) active @endif"
                                ...
                                <span class="nav-link-text">Active Deposits</span>
                            </a>
                            <!--//nav-link-->
                        </li>
                        <!--//nav-item-->
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link @if (Request::is('referrals')) active @endif"
                                href="{{ url('/referrals') }}">
                                <span class="nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link @if (Request::is('withdraw')) active @endif"
                                href="{{ url('/withdraw') }}">
                                <span class="nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
